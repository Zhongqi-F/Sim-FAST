...
%% In the future, if there are updates for panel plotting
% ori.newPanel{1}=[1,2,6,5];
% ori.newPanel{2}=[2,3,7,6];
% ori.newPanel{3}=[3,4,8,7];
% ori.newPanel{4}=[4,1,5,8];
% 
% ori.newPanel{5}=[5 6 12 11];
% ori.newPanel{6}=[6 9 13 12];
% ori.newPanel{7}=[9 10 14 13];
% ori.newPanel{8}=[5 10 14 11];
% 
% ori.newPanel{9}=[12 13 19 18];
% ori.newPanel{10}=[13 16 20 19];
% ori.newPanel{11}=[16 15 17 20];
% ori.newPanel{12}=[15 12 18 17];
% 
% ori.newPanel{13}=[17 18 2 23];
% ori.newPanel{14}=[17 22 24 23];
% ori.newPanel{15}=[22 21 3 24];
% ori.newPanel{16}=[21 18 2 3];
