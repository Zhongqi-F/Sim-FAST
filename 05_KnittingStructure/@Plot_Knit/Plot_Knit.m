classdef Plot_Knit < handle
    ...
    methods
        ...
        % Plot the shape of the system with rotational spring number
        Plot_Shape_SprNumber(obj)

        % Plot the shape of the system with rotational spring flat
        Plot_Shape_SprFlatNumber(obj)
