...
plots.Plot_DeformedShape(Umode1)
plots.Plot_DeformedShape(Umode2)
plots.Plot_DeformedShape(Umode3)
...
plots.Plot_DeformedShape(Umode1Fold)
plots.Plot_DeformedShape(Umode2Fold)
plots.Plot_DeformedShape(Umode3Fold)
