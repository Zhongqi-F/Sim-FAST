function [dist, oTriAPoint, oTriBPoint] = closestVertToTri(obj, iTriA, iTriB)
...
[A, Ap] = obj.simdTriPoint2(iTriA, iTriB(1:3));
[B, Bp] = obj.simdTriPoint2(iTriA, iTriB(4:6));
[C, Cp] = obj.simdTriPoint2(iTriA, iTriB(7:9));
