...
for i=1:N
    rot_spr_3N.node_ijk_mat=[rot_spr_3N.node_ijk_mat;
        ...
        (i-1)*13+5 (i-1)*13+7 (i-1)*13+9;
        (i-1)*13+4 (i-1)*13+5 (i-1)*13+6;
        (i-1)*13+5 (i-1)*13+6 (i-1)*13+8;
        (i-1)*13+10 (i-1)*13+11 (i-1)*13+12;
        (i-1)*13+11 (i-1)*13+12 (i-1)*13+8;
        (i-1)*13+13 (i-1)*13+14 (i-1)*13+15;
        (i-1)*13+14 (i-1)*13+15 (i-1)*13+9;
        ]; 
end
