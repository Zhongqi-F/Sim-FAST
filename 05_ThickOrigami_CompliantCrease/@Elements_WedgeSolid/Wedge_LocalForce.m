...
function Flocal=Wedge_LocalForce(obj,X,Kwedge,L0ref)
    ...
    for i=1:18
        ...
        Flocal(i)=1/2/delta*(obj.Wedge_Potential(TempXfor,Kwedge,L0ref)-...
            obj.Wedge_Potential(TempXback,Kwedge,L0ref));
