%% Local force vector of the bar element
% This function calculate the local internal force vector of a bar element
% using the bar potential and the central difference method. In the input,
% the X1 and X2 are the current nodal coordinates of the bar element. 

function Flocal=LocalForce(obj,X1,X2,L0,E,A)
