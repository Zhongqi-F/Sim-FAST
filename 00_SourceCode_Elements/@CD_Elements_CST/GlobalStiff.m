%% Assemble stiffness matrix of CST elements

function [Kcst]=GlobalStiff(obj,node,U)
    ...
    for i=1:rotSprNum
        ...
        Klocal=obj.LocalStiff(x,Xoriginal,E_vec(i),v_vec(i),t_vec(i));
