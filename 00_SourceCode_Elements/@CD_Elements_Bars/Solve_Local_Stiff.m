function Klocal=Solve_Local_Stiff(obj,X1,X2,L0,E,A)
    ...
    Klocal(1,:)=1/2/delta*(obj.Solve_Local_Force(TempX1for,X2,L0,E,A)-...
        obj.Solve_Local_Force(TempX1back,X2,L0,E,A));
    ...
    Klocal(2,:)=1/2/delta*(obj.Solve_Local_Force(TempX1for,X2,L0,E,A)-...
        obj.Solve_Local_Force(TempX1back,X2,L0,E,A));
    ...
    Klocal(3,:)=1/2/delta*(obj.Solve_Local_Force(TempX1for,X2,L0,E,A)-...
        obj.Solve_Local_Force(TempX1back,X2,L0,E,A));
    ...
    Klocal(4,:)=1/2/delta*(obj.Solve_Local_Force(X1,TempX2for,L0,E,A)-...
        obj.Solve_Local_Force(X1,TempX2back,L0,E,A));

    TempX2for=X2;
    TempX2for(2)=TempX2for(2)+delta;
    TempX2back=X2;
    TempX2back(2)=TempX2back(2)-delta;
    Klocal(5,:)=1/2/delta*(obj.Solve_Local_Force(X1,TempX2for,L0,E,A)-...
        obj.Solve_Local_Force(X1,TempX2back,L0,E,A));
    ...
    Klocal(6,:)=1/2/delta*(obj.Solve_Local_Force(X1,TempX2for,L0,E,A)-...
        obj.Solve_Local_Force(X1,TempX2back,L0,E,A));
