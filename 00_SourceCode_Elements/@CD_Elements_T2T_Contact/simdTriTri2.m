function [minDistTriTri, oTri1Point, oTri2Point] = simdTriTri2(obj, iTri1, iTri2)
...
[minDistTriTri, isFinished, oTri1Point, oTri2Point] = obj.closestEdgeToEdge(...
...
[tmpMinDist, isFinished, tri1Vector, tri2Vector] = obj.closestEdgeToEdge(...
...
[tmpMinDist, tri2Vector, tri1Vector] = obj.closestVertToTri(iTri2, iTri1);
if tmpMinDist < minDistTriTri
    oTri1Point = tri1Vector;
    oTri2Point = tri2Vector;
    minDistTriTri = tmpMinDist;
...
[tmpMinDist, tri1Vector, tri2Vector] = obj.closestVertToTri(iTri1, iTri2);
if tmpMinDist < minDistTriTri
    oTri1Point = tri1Vector;
    oTri2Point = tri2Vector;
    minDistTriTri = tmpMinDist;
...
if obj.simdTriContact(iTri1, iTri2)
    minDistTriTri = 0;
    oTri1Point = nan(1, 3);
    oTri2Point = nan(1, 3);
else
