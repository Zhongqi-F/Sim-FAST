...
function Klocal=Wedge_LocalStiff(obj,X,Kwedge,L0ref)
    ...
    for i=1:18
        ...
        Klocal(i,:)=1/2/delta*(obj.Wedge_LocalForce(TempXfor,Kwedge,L0ref)-...
            obj.Wedge_LocalForce(TempXback,Kwedge,L0ref));
