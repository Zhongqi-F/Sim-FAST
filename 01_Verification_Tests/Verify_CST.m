...
% 
% [cst_strain_mat] = cst.Calc_CST_Strain(bar_strain_mat,trans_mat);
% 
% [dedx,d2edx2] = cst.Calc_Derivatives(x_reshape,l_mat);
% 
% [Tcst]=cst.GlobalForce(U,dedx,cst_strain_mat,trans_mat);
% 
% [Kcst]=cst.GlobalStiff(U,dedx,d2edx2,cst_strain_mat,trans_mat);
...
stiffTheory=panelE*W*panelt/L
stiff=2*forceHis(10)/UrefHis(10)
