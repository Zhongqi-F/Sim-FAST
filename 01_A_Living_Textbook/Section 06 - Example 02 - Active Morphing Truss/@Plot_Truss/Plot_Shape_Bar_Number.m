...
for i=1:actbarNum
    x=0.5*(node0(actbarConnect(i,1),1)+...
        node0(actbarConnect(i,2),1));
    y=0.5*(node0(actbarConnect(i,1),2)+...
        node0(actbarConnect(i,2),2));
    z=0.5*(node0(actbarConnect(i,1),3)+...
        node0(actbarConnect(i,2),3));
    text(x,y,z,num2str(i),'Color','blue');
end